...
module RubyAMF
  module Configuration
    ...
    ClassMappings.register(
     ...
     ClassMappings.register(
      :actionscript  => 'vos.PostAuthor',
      :ruby          => 'PostAuthor',
      :type          => 'active_record',
      :attributes    => ["post_id", "name", "description"])

     ClassMappings.register(
      :actionscript  => 'vos.Comment',
      :ruby          => 'Comment',
      :type          => 'active_record',
      :associations  => ["action"],
     ...
     ClassMappings.register(
      :actionscript => 'vos.Action',
      :ruby         => 'Action',
      :type         => 'active_record',
      :attributes   => ["code", "label", "position"] )

      ClassMappings.register(
      :actionscript  => 'vos.Category',
      :ruby          => 'Category',
      :type          => 'active_record',
      :methods       => ["children"],
